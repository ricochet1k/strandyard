...
- [x] (subtask: Tcsz3-review-alternatives-recurrence-anchor-error-messag) Review alternatives: recurrence anchor error messages
- [x] (subtask: Thy9m-reliability-review-recurrence-anchor-errors) Reliability review: recurrence anchor errors
- [ ] (subtask: Ti8ig-usability-review-recurrence-anchor-errors) Usability review: recurrence anchor errors
