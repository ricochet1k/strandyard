...
blockers:
    ...
    - Tracyfv-add-graceful-error-handling-for-invalid-anchors-du
...
date_edited: 2026-02-01T20:23:29.705808Z
...
- [ ] (subtask: Tg96jgm) New Task: Add validation for anchor existence at recurrence creation
- [ ] (subtask: Tk1cdj4) New Task: Add audit logging for default anchor values
- [x] (subtask: Tnsrg) Reliability review: recurrence anchor flags
- [ ] (subtask: Tonge7b) Handle HEAD anchor mutability in recurrence definitions
- [ ] (subtask: Tracyfv) New Task: Add graceful error handling for invalid anchors during materialization
- [ ] (subtask: Trgquue) New Task: Ensure tasks_completed anchor requires completion timestamp metadata
