...
date_edited: 2026-01-30T02:22:10.222254Z
...
- [ ] (subtask: T2h9m-simplify-validation) Ensure Single Right Way Validation
- [x] (subtask: T3k8p-link-validation) Add Task Link Validation
- [x] (subtask: T7w4n-blocker-validation) Add Blocker Status Validation
