...
## Steps to Reproduce
1. Run `memmd next` - shows role file and filters by role
2. Run `memmd add issue --help` - defaults to "triage" role 
3. Run `memmd add leaf --help` - defaults to "developer" role
