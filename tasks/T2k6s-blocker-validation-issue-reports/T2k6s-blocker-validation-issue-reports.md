...
## Context
Capture recurring blocker validation errors as tracked issues with repro steps and logs.
...
- tasks/T2k6s-blocker-validation-issue-reports-subtask/task.md — short description of subtask
